...
- (void)drawInContext:(CGContextRef)context withPosition:(CGPoint)p andFont:(UIFont *)font andTextColor:(UIColor *)color andHeight:(float)height andWidth:(float)width{
    ...
    // core text 像Mac os一样坐标系原点在左下点，所以第一步需要先调整坐标系
    CGContextSetTextMatrix(context,CGAffineTransformIdentity);//反转坐标系
    CGContextTranslateCTM(context,0,height);//这一步为平移坐标系http://www.jianshu.com/p/288ae450e795
