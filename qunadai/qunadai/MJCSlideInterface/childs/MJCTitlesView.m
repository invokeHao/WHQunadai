...
-(void)setupBackBtn{
    ...
    [backBtn setFrame:CGRectMake(10, 10, 22, 22)];
//    [backBtn setImageEdgeInsets:UIEdgeInsetsMake(5, 0, 5, 20)];
    [backBtn addTarget:self action:@selector(backToPopVC) forControlEvents:UIControlEventTouchUpInside];
...
-(void)setTitlesArray:(NSArray *)titlesArray
{
    ...
    for (NSUInteger i = 0 ; i < titlesArray.count; i++) {
        ...
        if (_ItemWidthStyles == 0) {
            ...
            [tabbutton sizeToFit];
            maxleftMargin = 10;
            lineMargin = (self.jc_width-30-3*tabbutton.jc_width)/3;
