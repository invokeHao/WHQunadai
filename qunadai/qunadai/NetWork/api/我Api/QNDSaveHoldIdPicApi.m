...
@implementation QNDSaveHoldIdPicApi
{
    UIImage * _IdImage;
}
...
- (NSString *)requestUrl {
    return @"customer/saveHoldIdPic";
}

-(id)requestArgument{
    return @{@"userId":KGetUserID,@"x-auth-token": KGetACCESSTOKEN,@"imgStr":[self configTheImage:_IdImage]};
}

-(NSURLRequest *)buildCustomUrlRequest{
    WHLog(@"UserId = %@",KGetUserID);
