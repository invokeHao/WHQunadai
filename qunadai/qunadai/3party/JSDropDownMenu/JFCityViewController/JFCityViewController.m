...
- (void)viewDidLoad {
    ...
    [leftButton setImage:[UIImage imageNamed:@"login_icon_del"] forState:UIControlStateNormal];
    [leftButton setImageEdgeInsets:UIEdgeInsetsMake(5, 0, 5, 20)];
...
- (NSArray *)hotCityArray {
    if (!_hotCityArray) {
        _hotCityArray = @[@"北京市", @"上海市", @"广州市", @"深圳市",@"成都市", @"杭州市", @"南京市", @"武汉市", @"重庆市",@"青岛市",@"天津市", @"温州市"];
    }
...
- (UITableView *)rootTableView {
    if (!_rootTableView) {
        ...
        _rootTableView.sectionIndexColor = ThemeColor;
        _rootTableView.separatorInset = UIEdgeInsetsMake(0, 15, 0, 15);
        _rootTableView.separatorColor = lightGrayBackColor;
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (_HeaderSectionTotal == 4 && indexPath.section == 0) {
        ...
        return indexPath.section == (_HeaderSectionTotal - 1) ? 160 : 44;
    }
}
...
-(UIView*)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    UIView * header = [[UIView alloc]initWithFrame:CGRectMake(0, 0, ViewWidth, 40)];
    header.backgroundColor = grayBackgroundLightColor;
    ...
    if (_HeaderSectionTotal == 3) {
        switch (section) {
            ...
            case 2:
                ...
                break;
            default:
                title= _characterMutableArray[section];
                break;
        }
    }else {
        switch (section) {
    ...
    UILabel * titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(15, 13.5, ViewWidth-30, 13)];
    [titleLabel setFont:QNDFont(12.0)];
    [titleLabel setTextColor:QNDAssistText153Color];
