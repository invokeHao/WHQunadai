...
- (void)addSearchBar {
    ...
    searchBar.placeholder = @"请输入城市名称或首字母查询";
    
    [self addSubview:searchBar];
    self.searchBar = searchBar;
    
    [searchBar mas_makeConstraints:^(MASConstraintMaker *make) {
        make.width.offset(self.bounds.size.width - 24);
    ...
    separator.backgroundColor = lightGrayBackColor;
...
- (void)addLabels {
    ...
    currentLabel.textColor = blackTitleColor;
    currentLabel.font = QNDFont(14.0);
    ...
    _currentCityLabel.textColor  = ThemeColor;
    _currentCityLabel.textAlignment = NSTextAlignmentLeft;
    _currentCityLabel.font = QNDFont(14.0);
